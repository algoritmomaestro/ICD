...
function App() {
  ...
  const handleAreaChange = useCallback((e: React.ChangeEvent<HTMLSelectElement>) => {
    setSelectedArea((e.target as HTMLInputElement).value);
    setCurrentPage(1);
  }, []);

  const handleConceptChange = useCallback((e: React.ChangeEvent<HTMLSelectElement>) => {
    setSelectedConcept((e.target as HTMLInputElement).value);
    setCurrentPage(1);
  }, []);
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-6">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <select
                className="px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                value={itemsPerPage}
                onChange={(e) => setItemsPerPage(Number((e.target as HTMLInputElement).value))}
              >
